...
from (select * from zm_part where
...
(select * from zm_partsupp where
ps_ps_partkey in
(64,300,623,706,714,774,823,858,965,1146,1364,1427,1460,1778,1903,1981,1989,2143,2208,2423,2474,2545,2561,2567,2578,2784,2785,2812,2845,3000,3015,3047,3110,3124,3170,3229,3254,3340,3460,3777,3800,3811,3894,4090,4125,4476,4582,4964,5003,5481,5489,5551,5609,5815,5947,6090,6175,6267,6293,6404,6451,6699,6709,6786,6883,7074,7097,7215,7240,7242,7394,7400,7474,7481,7530,7547,7581,7829,7839,8410,8449,8518,8914,8957,8981,9050,9118,9143,9313,9427,9493,9527,9535,9664,9671,9689,9842,9889,9892)) ps,nation,region, (select min(ps_supplycost) as min_supplycost, ps_partkey from (select * from zm_partsupp where ps_ps_partkey in
