...
FROM "partsupp" AS F0
WHERE (F0."ps_partkey" <@ '{1,22131,25235,47244,56707,62798,66008,90826,97090,112679,115895,131576,134636,147368,150469,200001}'::int[])) F0 CROSS JOIN (
...
SELECT F0."ps_partkey" AS "ps_partkey", F0."ps_suppkey" AS "ps_suppkey", F0."ps_availqty" AS "ps_availqty", F0."ps_supplycost" AS "ps_supplycost", F0."ps_comment" AS "ps_comment"
FROM "partsupp" AS F0
WHERE (F0."ps_partkey" <@ '{1,22131,25235,47244,56707,62798,66008,90826,97090,112679,115895,131576,134636,147368,150469,200001}'::int[])) F1)) F0 CROSS JOIN "nation" AS F1)) F0 CROSS JOIN "region" AS F1)) F0 CROSS JOIN (
