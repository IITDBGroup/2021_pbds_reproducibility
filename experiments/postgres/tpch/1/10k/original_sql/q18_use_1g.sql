...
FROM "lineitem" AS F0
WHERE F0."l_orderkey" <@ '{1262631,1263234,1544100,1544676,2199712,2200327,2868645,2869218,2941954,2942531,3042820,3043393,3766723,3767398,4702599,4703170,4721696,4722247,4806528,4807079}'::int[]) F1)) F0 CROSS JOIN (
...
FROM "lineitem" AS F0
WHERE F0."l_orderkey" <@ '{1262631,1263234,1544100,1544676,2199712,2200327,2868645,2869218,2941954,2942531,3042820,3043393,3766723,3767398,4702599,4703170,4721696,4722247,4806528,4807079}'::int[]
