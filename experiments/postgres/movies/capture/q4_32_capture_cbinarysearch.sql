SELECT bit_or(F0."PROV_ratings1"::bit(32)) AS "PROV_ratings1", bit_or(F0."PROV_tags1"::bit(32)) AS "PROV_tags1", bit_or(F0."PROV_movies1"::bit(32)) AS "PROV_movies1"
FROM (
...
FROM (
SELECT count(1) AS "AGGR_0", F0."movieid" AS "GROUP_0", bit_or(F0."PROV_ratings1"::bit(32)) AS "PROV_ratings1"
FROM (
