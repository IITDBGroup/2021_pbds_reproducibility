SELECT bit_or(F0."PROV_ratings1"::bit(64)) AS "PROV_ratings1", bit_or(F0."PROV_tags1"::bit(64)) AS "PROV_tags1", bit_or(F0."PROV_movies1"::bit(64)) AS "PROV_movies1"
FROM (
