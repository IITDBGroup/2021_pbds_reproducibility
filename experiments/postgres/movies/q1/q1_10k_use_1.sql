...
FROM "movies" AS F0
WHERE ((((((((((F0."movieid" >= '108') AND (F0."movieid" < '111')) OR ((F0."movieid" >= '259') AND (F0."movieid" < '262'))) OR ((F0."movieid" >= '294') AND (F0."movieid" < '297'))) OR ((F0."movieid" >= '316') AND (F0."movieid" < '319'))) OR ((F0."movieid" >= '355') AND (F0."movieid" < '358'))) OR ((F0."movieid" >= '478') AND (F0."movieid" < '481'))) OR ((F0."movieid" >= '527') AND (F0."movieid" < '530'))) OR ((F0."movieid" >= '589') AND (F0."movieid" < '595'))) OR ((F0."movieid" >= '2569') AND (F0."movieid" < '2572')))) F0 CROSS JOIN "ratings" AS F1)) F0
