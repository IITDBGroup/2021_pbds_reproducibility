...
FROM "movies" AS F0
WHERE ((((F0."movieid" >= 69) AND (F0."movieid" < 138)) OR ((F0."movieid" >= 206) AND (F0."movieid" < 619))) OR ((F0."movieid" >= 2539) AND (F0."movieid" < 2608)))) F0 CROSS JOIN (
...
FROM "ratings" AS F0
WHERE (((F0."movieid" >= 95) AND (F0."movieid" < 745)) OR ((F0."movieid" >= 2396) AND (F0."movieid" < 2639)))) F1)) F0
