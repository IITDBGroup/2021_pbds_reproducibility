...
FROM ((SELECT * FROM "badges_b1" WHERE b_userid <@ '{5678,7970,13618,19370,22174,25172,27959,35197,99967,104023,111561,115436,154126,158348}'::int[]) F0_0 CROSS JOIN (
...
FROM "users_b1" F0_0
WHERE (F0_0."u_id" <@ '{5678,7970,13618,19370,22174,25172,27959,35197,99967,104023,111561,115436,154126,158348}'::int[])) F1_0)) F0_0
