...
FROM "users_b1" F0_0
WHERE (F0_0."u_id" <@ '{1,62313,99804,134824,540953,560511,1123241,1145096,1485260,1498729,2893517,2906736,3723835,3736086}'::int[])) F0_0 CROSS JOIN (SELECT * FROM "posts_b1" WHERE p_owneruserid <@ '{1,62313,99804,134824,540953,560511,1123241,1145096,1485260,1498729,2893517,2906736,3723835,3736086}'::int[]) F1_0)) F0_0
