...
FROM "users_b1" F0_0
WHERE (F0_0."u_id" <@ '{1,25565,99804,134824,199361,219828,420412,441204,499826,520237,1042073,1063027,1402819,1417036,1485260,1498729}'::int[])) F0_0 CROSS JOIN ( SELECT * FROM "comments_b1" WHERE c_userid <@ '{1,25565,99804,134824,199361,219828,420412,441204,499826,520237,1042073,1063027,1402819,1417036,1485260,1498729}'::int[]) F1_0)) F0_0 CROSS JOIN (SELECT * FROM "posts_b1" WHERE p_owneruserid <@ '{1,25565,99804,134824,199361,219828,420412,441204,499826,520237,1042073,1063027,1402819,1417036,1485260,1498729}'::int[]) F1_0)) F0_0
