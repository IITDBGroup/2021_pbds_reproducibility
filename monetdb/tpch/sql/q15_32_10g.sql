select s_suppkey, s_name, s_address, s_phone, total_revenue from (select * from supplier where ("s_suppkey" >= 9244) AND ("s_suppkey" < 12316)
...
("l_suppkey" >= 18935) AND ("l_suppkey" < 21896)
