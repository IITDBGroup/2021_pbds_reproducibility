select s_suppkey, s_name, s_address, s_phone, total_revenue from (select * from supplier where ("s_suppkey" >= 9504) AND ("s_suppkey" < 11037)
...
("l_suppkey" >= 9506) AND ("l_suppkey" < 10945)
