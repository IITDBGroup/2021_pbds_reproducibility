select s_suppkey, s_name, s_address, s_phone, total_revenue from (select * from supplier where ("s_suppkey" >= 10900) AND ("s_suppkey" < 10910)
...
("l_suppkey" >= 10897) AND ("l_suppkey" < 10907)
