...
num_range = ["No-PS","PS","MV","MV+PS"]
#each line color
#l_color = ["Deepskyblue","Red","Springgreen","Hotpink"]
l_color = ["Red","Deepskyblue","orange","violet"]
...
for f in range(len(fname)):
	...
	for i in range(len(num_range)):
		...
		plt.legend(loc='lower center',prop={'size': 20}, ncol=2, facecolor='white', framealpha=1)
		#plt.xticks(x1+width*i-0.2, ('Q3','Q10','Q15','Q18'))
		plt.xticks([0,1,2,3,4,5], ['S-Q6','S-Q7','S-Q8','S-Q9','S-Q10','S-Q11']);
		#plt.ylim([0.1, 100])
