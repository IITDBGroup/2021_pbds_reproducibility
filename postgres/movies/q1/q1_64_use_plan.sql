...
FROM "ratings" AS F0
WHERE (((((F0."movieid" >= 94) AND (F0."movieid" < 163)) OR ((F0."movieid" >= 223) AND (F0."movieid" < 410))) OR ((F0."movieid" >= 471) AND (F0."movieid" < 631))) OR ((F0."movieid" >= 2541) AND (F0."movieid" < 2664)))) F1)) F0
